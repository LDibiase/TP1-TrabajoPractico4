...
public class Ej1 {
	...
	public static void main(String[] args) {
		...
		// 1) En los 3 casos al ingresar un valor no numerico, se maneja la exception y el programa continua.
		// 2) Comentando los try catch, se produce una exception y el programa termina.
		// 3) Cuando el error es generado en 'pedirNumeroEntero', se produce la exception y el programa termina.
